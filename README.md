...
**Live dashboard:** https://gfdrr.github.io/sirs-public-private/ &nbsp;·&nbsp; **Methodology:** [`methodology.md`](methodology.md)
...
A MapLibre dashboard lives in [`docs/webmap/`](docs/webmap/) and is published via GitHub Pages at **https://gfdrr.github.io/sirs-public-private/**. It lets you click any school to see its label, model probability, audit trail, and the rule(s) that fired. Three view modes: rules-only, rules+model, population-aware. The public webmap shows only the **OpenStreetMap-sourced subset** (~1,570 schools); the full Giga+OSM dataset is kept internal pending a data-sharing agreement.
